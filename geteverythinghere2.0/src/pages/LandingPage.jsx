      ...
      <section className="about-section" id="about">
        <div className="about-inner">
          <div className="about-text">
            ...
            <p>
              At GetEverythingHere, we're passionate about bringing you the latest in technology. From smartphones to smart home devices, we curate a selection of high-quality gadgets to enhance your everyday life.
